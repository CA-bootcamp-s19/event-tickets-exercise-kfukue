...
contract EventTicketsV2 {
    ...
    */
    ...
    function addEvent(string memory _description, string memory _website, uint _numberOfTickets)
        public
        isOwner()
        returns (uint)
    {
        ...
        emit LogEventAdded(_description, _website, _numberOfTickets, newId);
        idGenerator++;
        return newId;
    }
